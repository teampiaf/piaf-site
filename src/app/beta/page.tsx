// Fichier: src/app/beta/page.tsx
"use client"; // Important car tu utilises des animations et des interactions

import React from 'react';
import { ArrowLeft, Instagram, Linkedin } from 'lucide-react';

// --- LE COMPOSANT PRINCIPAL (PAGE) ---
export default function BetaPage() {
  return (
    <div className="min-h-screen bg-[#F9F7F2] flex flex-col items-center justify-center p-4 text-center font-sans selection:bg-[#4AA171] selection:text-white">
      ...
      <a href="/" className="absolute top-8 left-8 p-3 rounded-full bg-white shadow-md hover:bg-gray-50 transition-colors group z-50">
